...
SARS_URL = 'https://raw.githubusercontent.com/yangkevin2/coronavirus_data/master/data/AID1706_binarized_sars.csv'

def load_sars(featurizer='GraphConv',
               split='random',
               reload=True,
               K=4,
               data_dir=None,
    ...
    download_url("https://raw.githubusercontent.com/yangkevin2/coronavirus_data/master/data/AID1706_binarized_sars.csv")
    data_dir = os.path.join(dc.utils.get_data_dir())
    dataset_file= os.path.join(dc.utils.get_data_dir(), "AID1706_binarized_sars.csv")
    ...
    loader = dc.data.CSVLoader(tasks = sars_tasks, smiles_field="smiles", featurizer=featurizer)
    ...
    return sars_tasks, all_dataset, transformers

sars_tasks, sars_datasets, transformers = load_sars(featurizer='GraphConv', reload=False)
